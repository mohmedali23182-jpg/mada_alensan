...
const fallbackAvatar = undefined as string | undefined;
...
function authorFromPost(post: PostWithRelations): Author {
  ...
  return {
    ...
    bio: contributor?.bio || "كاتب في منصة مدى الإنسان.",
