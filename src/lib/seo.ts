...
export function buildMetadata(input: {
  ...
  const description = input.description || "منصة إنسانية، اجتماعية، ثقافية، علمية، ومتنوعة تنقل قصص الناس وقضاياهم بكرامة ووضوح.";
  return {
    title,
    description,
...
export function organizationJsonLd() {
  return {
    ...
    name: siteName,
    url: siteUrl,
    description: "منصة إنسانية، اجتماعية، ثقافية، علمية، ومتنوعة",
  };
}
