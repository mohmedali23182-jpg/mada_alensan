...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!author) return {};
  return buildMetadata({ title: `${author.name} | كتّاب مدى الإنسان`, description: author.bio || "كاتب في مدى الإنسان", image: author.avatarUrl || undefined, keywords: [author.name, "مدى الإنسان", "أقلام الناس"] });
}
