...
async function getAuthor(slug: string) {
  return prisma.contributor.findUnique({ where: { slug }, include: { posts: { where: { status: "PUBLISHED", deletedAt: null, visibility: "PUBLIC" }, include: { category: true, contributor: true, author: { select: { id: true, name: true, email: true, avatarUrl: true, role: true } }, tags: { include: { tag: true } } }, orderBy: { publishedAt: "desc" } } } });
}
